...
def read_File():
    ...
    ticket = open("python_list.txt") #creates object that opens text file
...
def read_AND_Write_File():
    ...
    ticket = open("python_list.txt")
    data = open("purchasefrequency.dat", "w")
    products = ticket.read().split() #creates object that holds each line info from ticket object
    unique_Product = sorted(set(products)) #sorts the items
    ...
    histo_data = open("purchasefrequency.dat", "r") # read .dat file
